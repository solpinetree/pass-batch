...
import com.sol.passbatch.repository.booking.BookingRepository;
import com.sol.passbatch.repository.booking.BookingStatus;
import com.sol.passbatch.repository.pass.PassEntity;
import com.sol.passbatch.repository.pass.PassRepository;
...
public class UsePassesJobConfig {
    ...
    @Bean
    public Job userPassesJob(JobRepository jobRepository, PlatformTransactionManager platformTransactionManager) {
        return new JobBuilder("userPassesJob", jobRepository)
                .start(usePassesStep(jobRepository, platformTransactionManager))
                .build();
    }

    @Bean
    public Step usePassesStep(JobRepository jobRepository, PlatformTransactionManager platformTransactionManager) {
